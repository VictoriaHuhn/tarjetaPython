...
def test_ViajesRealizados():
	...
	Lista[0]=Viaje(K1,"06/07/2008 7:20", 1.90)
	Lista[1]=Viaje(v122,"06/07/2008 7:00", 5.75)
	Lista[2]=Viaje(K1,"06/07/2008 6:40", 1.90)
	...
	ListaM[3]=Viaje(v122,"06/07/2008 6:20", 2.90)
	ListaM[4]=Viaje()
	ListaM[5]=Viaje()
